...
function [ fileName ] = extract_nifti_header( niiData, fileName )
%Extract the NIFTI header in text file or command prompt.
%This version supports only standard NIFTI files. 
%
...
if ischar(niiData)
	data.hdr = load_untouch_header_only_gz(niiData);
